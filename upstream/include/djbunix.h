...
/* Same, with an additional pipe from the parent to the child */

extern unsigned int child_spawn3 (char const *, char const *const *, char const *const *, unsigned int, unsigned int, int *) ;
